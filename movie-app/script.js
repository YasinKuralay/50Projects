...
const SEARCH_API = `https://api.themoviedb.org/3/search/movie?api_key=c770da96a77f7fd10222f95ef430a824&query="`; //need to elaborate, shouldn't we add an additional double quote at the end of the concatenation?
